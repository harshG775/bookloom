        ...
        <section className="bg-zinc-50 flex flex-col justify-center min-h-dvh">
            <div className="max-w-(--breakpoint-xl) mx-auto px-3 sm:px-6 lg:px-10">
                ...
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-6">
                    ...
                    <div className="flex flex-col justify-between rounded-2xl bg-secondary/40 p-8 transition-all hover:shadow-sm lg:p-12 group">
                        <div>
                            <div className="mb-12 flex h-14 w-14 items-center justify-center rounded-xl border border-border bg-white shadow-sm  group-hover:scale-110 transition-transform duration-500">
                                <Brain className="text-foreground size-8" />
                            </div>
                    ...
                    <div className="flex flex-col gap-4 lg:gap-6">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:gap-6">
                            ...
                            {/* Expert Case Studies */}
                            <div className="rounded-2xl bg-secondary/40 p-8 border border-transparent transition-colors hover:border-border group">
                                <div className="mb-8 flex h-10 w-10 items-center justify-center rounded-lg border border-border bg-white shadow-sm group-hover:scale-110 transition-transform">
                        ...
                        <div className="flex flex-col items-start gap-6 rounded-2xl bg-secondary p-8 sm:flex-row sm:items-center lg:p-10 group">
                            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-white shadow-md group-hover:rotate-12 transition-transform duration-500">
                                <Infinity className="text-foreground size-8" />
                            </div>
                            <div>
